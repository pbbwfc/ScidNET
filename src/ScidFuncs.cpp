...
int ScidFuncs::Base::Autoloadgame(bool getbase, unsigned int basenum)
{
	if (getbase)
	{
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::Base::Open(String^ basenm)
{
...
bool ScidFuncs::Base::Isreadonly()
{
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::Base::Getfilename(String^% name)
{
	scidBaseT* basePtr = db;
	if (!basePtr->inUse)
	{
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::Base::Create(String^ basenm)
{
	msclr::interop::marshal_context oMarshalContext;
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::Base::Import(int% numgames, String^% msgs, String^ pgnfile)
{
	msclr::interop::marshal_context oMarshalContext;
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::Base::Switch(int basenum)
{
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::ScidGame::Load(unsigned int gnum)
{
	if (!db->inUse)
	{
		return -1;
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::ScidGame::Save(unsigned int gnum, int basenum)
{
	if (basenum < 1 || basenum > MAX_BASES)
	{
		return -1; //Invalid base number
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::ScidGame::Delete(unsigned int gnum)
{
	if (!db->inUse)
	{
		return -1;
...
/// <param name="basenum">the base containing the game</param>
/// <returns>returns 0 if successful</returns>
int ScidFuncs::ScidGame::SavePgn(String^ pgnstr, unsigned int gnum, int basenum)
{
	msclr::interop::marshal_context oMarshalContext;
	...
	return ScidFuncs::ScidGame::Save(gnum,basenum);
}
...
/// </summary>
/// <returns>returns 0 if successful</returns>
int ScidFuncs::ScidGame::StripComments()
{
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::ScidGame::GetTag(String^ tag, String^% val)
{
	msclr::interop::marshal_context oMarshalContext;
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::ScidGame::SetTag(String^ tag, String^ val)
{
	msclr::interop::marshal_context oMarshalContext;
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::ScidGame::GetFen(String^% fen)
{
	char boardStr[200];
...
bool ScidFuncs::ScidGame::HasNonStandardStart()
{
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::ScidGame::GetMoves(System::Collections::Generic::List<String^>^% mvs, int maxply)
{
	char sanStr[20];
	uint plyCount = 0;
...
/// <param name="maxply">the maximu ply to use, if set to -1 returns all moves</param>
/// <returns>returns 0 if successful</returns>
int ScidFuncs::ScidGame::GetMovesPosns(System::Collections::Generic::List<String^>^% mvs, System::Collections::Generic::List<String^>^% posns, int maxply)
{
	char sanStr[20];
	char boardStr[200];
	uint plyCount = 0;
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::ScidGame::List(System::Collections::Generic::List<gmui^>^% gms, unsigned int start, unsigned int count)
{
	if (!db->inUse)
	{
		return 0;
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::ScidGame::Pgn(String^% pgn)
{
	scidBaseT* base = db;
	Game* g = db->game;
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::Eco::ScidGame(String^% eco)
{
	int found = 0;
	uint ply = 0;
	if (!ecoBook)
...
int ScidFuncs::Eco::Read(String^ econm)
{
	msclr::interop::marshal_context oMarshalContext;
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::Eco::Base(String^% msgs)
{
	if (!ecoBook)
	{
...
/// <returns>returns 0 if successful</returns>
int treeSearch(System::Collections::Generic::List<ScidFuncs::mvstats^>^% mvsts, ScidFuncs::totstats^% tsts, String^ fenstr, int basenum, bool returnTree)
{
	msclr::interop::marshal_context oMarshalContext;
	...
	if (returnTree)
	{
		...
		for (uint count = 0; count < tree->moveCount; count++, node++)
		{
			...
			ScidFuncs::mvstats^ mvst = gcnew ScidFuncs::mvstats();
...
/// <param name="basenum">the number of the base</param>
/// <returns>returns 0 if successful</returns>
int ScidFuncs::Tree::Search(System::Collections::Generic::List<mvstats^>^% mvsts, totstats^% tsts, String^ fenstr, int basenum)
{
...
/// <param name="basenum">the number of the base</param>
/// <returns>returns 0 if successful</returns>
int ScidFuncs::Tree::Write(int basenum)
{
	scidBaseT* base = db;
	if (basenum >= 1 && basenum <= MAX_BASES)
	{
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::Tree::Populate(int ply, int basenum, uint numgames)
{
	scidBaseT* base = db;
	if (basenum >= 1 && basenum <= MAX_BASES)
	{
...
/// <returns>returns 0 if successful</returns>
int ScidFuncs::Search::Board(String^ fenstr,int basenum)
{
	System::Collections::Generic::List<mvstats^>^ mvsts = gcnew System::Collections::Generic::List<mvstats^> ();
	totstats^ tsts = gcnew totstats();
